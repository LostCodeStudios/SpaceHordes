...
namespace GameLibrary.Physics.Factories
{
    ...
    public static class PathManager
    {
        ...
        /// <returns></returns>
        public static List<Body> EvenlyDistributeShapesAlongPath(PhysicsWorld world, Path path, IEnumerable<Shape> shapes,
        ...
        public static List<RevoluteJoint> AttachBodiesWithRevoluteJoint(PhysicsWorld world, List<Body> bodies,
        ...
        /// <returns></returns>
        public static List<SliderJoint> AttachBodiesWithSliderJoint(PhysicsWorld world, List<Body> bodies, Vector2 localAnchorA,
                                                                    Vector2 localAnchorB, bool connectFirstAndLast,
