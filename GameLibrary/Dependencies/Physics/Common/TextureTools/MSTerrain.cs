...
namespace GameLibrary.Dependencies.Physics.Common
{
    ...
    public class MSTerrain
    {
        ...
        /// Generated bodies.
        /// </summary>
        private List<PhysicsBody>[,] _bodyMap;
        ...
        public MSTerrain(PhysicsWorld world, AABB area)
        {
            World = world;
        ...
        public void Initialize()
        {
            ...
            _bodyMap = new List<PhysicsBody>[_xnum, _ynum];
        ...
        private void GenerateTerrain(int gx, int gy)
        {
            ...
            _bodyMap[gx, gy] = new List<PhysicsBody>();
            ...
            foreach (var item in polys)
            {
                ...
                Vertices p = GameLibrary.Dependencies.Physics.Common.PolygonManipulation.SimplifyTools.CollinearSimplify(item);
