...
namespace GameLibrary.Dependencies.Physics.Dynamics.Joints
{
    ...
    /// </summary>
    public class RevoluteJoint : PhysicsJoint
    {
        ...
        public RevoluteJoint(PhysicsBody bodyA, PhysicsBody bodyB, Vector2 localAnchorA, Vector2 localAnchorB)
            : base(bodyA, bodyB)
        {
            JointType = JointType.Revolute;
        ...
        {
            PhysicsBody b1 = BodyA;
            PhysicsBody b2 = BodyB;
