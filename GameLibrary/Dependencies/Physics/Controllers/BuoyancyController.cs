...
namespace GameLibrary.Dependencies.Physics.Controllers
{
    public sealed class BuoyancyController : Controller
    {
        ...
        private Dictionary<int, PhysicsBody> _uniqueBodies = new Dictionary<int, PhysicsBody>();
        ...
        public override void Update(float dt)
        {
            ...
            foreach (KeyValuePair<int, PhysicsBody> kv in _uniqueBodies)
            {
                PhysicsBody body = kv.Value;
