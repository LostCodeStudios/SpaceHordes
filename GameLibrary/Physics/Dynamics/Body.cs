...
using GameLibrary.Physics.Common.PhysicsLogic;
...
namespace GameLibrary.Physics.Dynamics
{
    /// <summary>
    /// The body type.
    /// </summary>
    ...
    public class Body : IDisposable
    {
        ...
        public Body(PhysicsWorld world)
            : this(world, null)
        {
        }

        public Body(PhysicsWorld world, object userData)
        {
            FixtureList = new List<Fixture>(32);
