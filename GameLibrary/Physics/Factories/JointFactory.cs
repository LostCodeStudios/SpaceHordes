...
namespace GameLibrary.Physics.Factories
{
    ...
    public static class JointFactory
    {
        ...
        /// <returns></returns>
        public static FixedRevoluteJoint CreateFixedRevoluteJoint(PhysicsWorld world, Body body, Vector2 bodyAnchor,
                                                                  Vector2 worldAnchor)
        {
        ...
        /// <returns></returns>
        public static WeldJoint CreateWeldJoint(PhysicsWorld world, Body bodyA, Body bodyB, Vector2 localanchorB)
        {
        ...
        public static WeldJoint CreateWeldJoint(PhysicsWorld world, Body bodyA, Body bodyB, Vector2 localAnchorA,
        ...
        /// <param name="axis"></param>
        /// <returns></returns>
        public static PrismaticJoint CreatePrismaticJoint(PhysicsWorld world, Body bodyA, Body bodyB, Vector2 localanchorB,
                                                          Vector2 axis)
        {
        ...
        public static FixedPrismaticJoint CreateFixedPrismaticJoint(PhysicsWorld world, Body body, Vector2 worldAnchor,
                                                                    Vector2 axis)
        {
        ...
        /// <param name="axis"></param>
        /// <returns></returns>
        public static LineJoint CreateLineJoint(PhysicsWorld world, Body bodyA, Body bodyB, Vector2 localanchorB, Vector2 axis)
        {
        ...
        /// <param name="body">The body.</param>
        /// <returns></returns>
        public static FixedAngleJoint CreateFixedAngleJoint(PhysicsWorld world, Body body)
        {
        ...
        public static DistanceJoint CreateDistanceJoint(PhysicsWorld world, Body bodyA, Body bodyB, Vector2 anchorA,
                                                        Vector2 anchorB)
        {
        ...
        public static FixedDistanceJoint CreateFixedDistanceJoint(PhysicsWorld world, Body body, Vector2 localAnchor,
                                                                  Vector2 worldAnchor)
        {
        ...
        public static FrictionJoint CreateFrictionJoint(PhysicsWorld world, Body bodyA, Body bodyB, Vector2 anchorA,
                                                        Vector2 anchorB)
        {
        ...
        public static FixedFrictionJoint CreateFixedFrictionJoint(PhysicsWorld world, Body body, Vector2 bodyAnchor)
        {
        ...
        public static GearJoint CreateGearJoint(PhysicsWorld world, Joint jointA, Joint jointB, float ratio)
        {
        ...
        public static PulleyJoint CreatePulleyJoint(PhysicsWorld world, Body bodyA, Body bodyB, Vector2 groundAnchorA,
        ...
        public static SliderJoint CreateSliderJoint(PhysicsWorld world, Body bodyA, Body bodyB, Vector2 anchorA,
