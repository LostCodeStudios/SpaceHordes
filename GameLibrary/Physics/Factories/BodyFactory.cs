...
namespace GameLibrary.Physics.Factories
{
    public static class BodyFactory
    {
        public static Body CreateBody(PhysicsWorld world)
        {
            return CreateBody(world, null);
        }

        public static Body CreateBody(PhysicsWorld world, object userData)
        {
            Body body = new Body(world, userData);
            return body;
        }

        public static Body CreateBody(PhysicsWorld world, Vector2 position)
        {
            return CreateBody(world, position, null);
        }

        public static Body CreateBody(PhysicsWorld world, Vector2 position, object userData)
        {
        ...
        public static Body CreateEdge(PhysicsWorld world, Vector2 start, Vector2 end)
        {
            return CreateEdge(world, start, end, null);
        }

        public static Body CreateEdge(PhysicsWorld world, Vector2 start, Vector2 end, object userData)
        {
        ...
        public static Body CreateLoopShape(PhysicsWorld world, Vertices vertices)
        {
            return CreateLoopShape(world, vertices, null);
        }

        public static Body CreateLoopShape(PhysicsWorld world, Vertices vertices, object userData)
        {
            return CreateLoopShape(world, vertices, Vector2.Zero, userData);
        }

        public static Body CreateLoopShape(PhysicsWorld world, Vertices vertices, Vector2 position)
        {
        ...
        public static Body CreateRectangle(PhysicsWorld world, float width, float height, float density)
        {
            return CreateRectangle(world, width, height, density, null);
        }

        public static Body CreateRectangle(PhysicsWorld world, float width, float height, float density, object userData)
        {
            return CreateRectangle(world, width, height, density, Vector2.Zero, userData);
        }

        public static Body CreateRectangle(PhysicsWorld world, float width, float height, float density, Vector2 position)
        {
        ...
        public static Body CreateCircle(PhysicsWorld world, float radius, float density)
        {
            return CreateCircle(world, radius, density, null);
        }

        public static Body CreateCircle(PhysicsWorld world, float radius, float density, object userData)
        {
            return CreateCircle(world, radius, density, Vector2.Zero, userData);
        }

        public static Body CreateCircle(PhysicsWorld world, float radius, float density, Vector2 position)
        {
            return CreateCircle(world, radius, density, position, null);
        }

        public static Body CreateCircle(PhysicsWorld world, float radius, float density, Vector2 position, object userData)
        {
            Body body = CreateBody(world, position);
        ...
        public static Body CreatePolygon(PhysicsWorld world, Vertices vertices, float density)
        {
            return CreatePolygon(world, vertices, density, null);
        }

        public static Body CreatePolygon(PhysicsWorld world, Vertices vertices, float density, object userData)
        {
            return CreatePolygon(world, vertices, density, Vector2.Zero, userData);
        }

        public static Body CreatePolygon(PhysicsWorld world, Vertices vertices, float density, Vector2 position)
        {
        ...
        public static Body CreateCompoundPolygon(PhysicsWorld world, List<Vertices> list, float density)
        {
        ...
        public static Body CreateGear(PhysicsWorld world, float radius, int numberOfTeeth, float tipPercentage,
        ...
        /// <returns></returns>
        public static Body CreateCapsule(PhysicsWorld world, float height, float topRadius, int topEdges,
                                         float bottomRadius,
        ...
        /// <param name="position">The position.</param>
        /// <returns></returns>
        public static Body CreateRoundedRectangle(PhysicsWorld world, float width, float height, float xRadius,
                                                  float yRadius,
        ...
        public static BreakableBody CreateBreakableBody(PhysicsWorld world, Vertices vertices, float density, object userData)
        {
        ...
        public static Body CreateLineArc(PhysicsWorld world, float radians, int sides, float radius, Vector2 position,
        ...
        public static Body CreateSolidArc(PhysicsWorld world, float density, float radians, int sides, float radius,
