...
namespace GameLibrary.Helpers
{
    ...
    public static class ConvertUnits
    {
        ...
        {
            return new Vector2(displayUnits.X * _simUnitsToDisplayUnitsRatio, displayUnits.Y * _simUnitsToDisplayUnitsRatio);
        }
        ...
        public static Vector2[] ToDisplayUnits(Vector2[] vector2)
        {
            Vector2[] list = new Vector2[vector2.Length];

            for (int i = 0; i < vector2.Length; i++)
            {
                list[i] = ToDisplayUnits(vector2[i]);
            }
            return list;
        }
    }
