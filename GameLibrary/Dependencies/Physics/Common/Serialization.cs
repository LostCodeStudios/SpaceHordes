...
namespace GameLibrary.Dependencies.Physics.Common
{
    ...
    public class WorldXmlSerializer
    {
        ...
        private void SerializeBody(PhysicsBody body)
        {
        ...
        public void Serialize(PhysicsWorld world, Stream stream)
        {
            ...
            {
                PhysicsBody body = world.BodyList[i];
            ...
            {
                PhysicsJoint joint = world.JointList[i];
        ...
        private int FindBodyIndex(PhysicsBody body)
        {
    ...
    public class WorldXmlDeserializer
    {
        ...
        private List<PhysicsJoint> _joints = new List<PhysicsJoint>();
        private List<Shape> _shapes = new List<Shape>();

        public PhysicsWorld Deserialize(Stream stream)
        {
