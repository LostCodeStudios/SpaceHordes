...
namespace GameLibrary.Dependencies.Physics.Dynamics.Joints
{
    ...
    /// </summary>
    public class FrictionJoint : PhysicsJoint
    {
        ...
        public FrictionJoint(PhysicsBody bodyA, PhysicsBody bodyB, Vector2 localAnchorA, Vector2 localAnchorB)
            : base(bodyA, bodyB)
        {
            JointType = JointType.Friction;
        ...
        {
            PhysicsBody bA = BodyA;
            PhysicsBody bB = BodyB;
